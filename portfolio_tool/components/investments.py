...
class InvestmentPortfolio:
    ...
    def fund_pull(self, initiate=False):
        ...
        key_str = ', '.join(self.invested_cap_keys)
...
if __name__ == '__main__':
    ...
    investments.fund_pull(initiate=True)
    investments.fund_update()
    #investments.other_investments_history()
